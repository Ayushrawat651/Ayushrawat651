...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr><td>Web Development</td><td>" . $row["Web Development"] . "</td></tr>";
            echo "<tr><td>Compiler Design</td><td>" . $row["Compiler Design"] . "</td></tr>";
            echo "<tr><td>Image Processing</td><td>" . $row["Image Processing"] . "</td></tr>";
