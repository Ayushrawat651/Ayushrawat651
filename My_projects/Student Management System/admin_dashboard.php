...
<body>
	...
	<span id="top_span"><marquee>Note:- Edit your information, if wrong.</marquee></span>
	<div id="left_side">
		<br><br><br>
		<form action="" method="post">
			<table>
				...
				<tr>
					<td>
						<input type="submit" name="enter_marks" value="enter marks">
					</td>
				</tr>
			</table>
		</form>
			...
			<?php
				if(isset($_POST['enter_marks']))
				{
					...
					<form action="marks.php" method="post">
						...
						<input type="text" name="s_no" id="s_no"/></br></br>
						<label for="Web_Development">Web Development:</label>
						<input type="text" name="Web_Development" id="Web_Development"/></br></br>
						<label for="Compiler_Design">Compiler Design:</label>
						<input type="text" name="Compiler Design" id="Compiler_Design"/></br></br>
						<label for="Image_Processing">Image Processing:</label>
						<input type="text" name="Image_Processing" id="Image Processing"/></br></br>
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" name="Web_Development" required>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" name="Image_Processing" required>
								</td>
							</tr>
							<tr>
								<td></td>
								<td><br><input type="submit" name="marks" value="Add Marks"></td>
							</tr>
						</table>
					</form>
					</center>
